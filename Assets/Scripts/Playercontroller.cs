...
public class Playercontroller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump") && isOnTheGround && !gameManager.gameOver)  //con esta condicion hacemos que si se cumplen las 3 reglas (que se presiona el boton de espacio y que la variable isOnTheGround es true y que gameOver sea false) el objeto saltar en y, y que sea una fuerza tipo impulso, y que la variable isOnTheGround pase a ser false.
        {
        ...
        if (Input.GetKey(KeyCode.UpArrow) || Input.GetButton("ShootVerticalPos"))
        {
        ...
        else if (Input.GetKey(KeyCode.DownArrow) || Input.GetButton("ShootVerticalNeg"))
        {
        ...
        else if (Input.GetKey(KeyCode.RightArrow) || Input.GetButton("ShootHorizontalPos"))
        {
        ...
        else if (Input.GetKey(KeyCode.LeftArrow) || Input.GetButton("ShootHorizontalNeg"))
        {
            transform.rotation = Quaternion.Euler(0, -90, 0);
            offset = Vector3.left;
